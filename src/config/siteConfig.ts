...
export const siteConfig: SiteConfig = {
  title: "Mclaine",
  subtitle: "my mildly niche digital space",
  siteURL: "https://mclaine.pages.dev/", // 请替换为你的站点URL，以斜杠结尾
  siteStartDate: "2026-08-21", // 站点开始运行日期，用于站点统计组件计算运行天数
  ...
  banner: {
    ...
    src: {
      desktop: ["/assets/desktop-banner/roses.jpg"], // 桌面横幅图片
      mobile: ["/assets/mobile-banner/Mizuki.png"], // 移动横幅图片
    }, // 使用本地横幅图片
